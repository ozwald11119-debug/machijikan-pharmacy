...
const whatItShows={
 'TP':'血液中のたんぱく質の総量。栄養状態や肝臓・腎臓の状態の手がかりです。','Alb':'血液中の主要なたんぱく質。栄養状態と、肝臓で作る力・腎臓からの漏れをみます。','Cr':'筋肉でできる老廃物。腎臓が老廃物を排泄する力の手がかりです。','eGFR':'クレアチニンなどから推定する、腎臓のろ過能力の目安です。','UA':'プリン体が分解されてできる尿酸。痛風・尿路結石のリスク評価に使います。','HDL-C':'血管壁からコレステロールを回収する働きをもつリポたんぱく由来のコレステロールです。','LDL-C':'肝臓から全身へコレステロールを運ぶリポたんぱく由来のコレステロール。高いと血管壁にたまり、動脈硬化と関連します。','non-HDL':'HDL以外の、動脈硬化に関係するコレステロール全体の目安です。','TG':'食事や肝臓で作られる中性脂肪。エネルギーの貯蔵・運搬に関係します。','AST':'肝臓・心臓・筋肉などにある酵素。細胞が傷つくと血液中で増えます。','ALT':'主に肝臓の細胞に多い酵素。肝細胞が傷ついていないかをみる手がかりです。','γ-GT':'肝臓・胆道系に多い酵素。胆汁の流れ、飲酒や薬剤の影響をみる手がかりです。','FPG':'採血時点の血糖。空腹時の糖の状態をみます。','HbA1c':'赤血球のヘモグロビンに結びついた糖の割合。過去1〜2か月の平均的な血糖状態の目安です。','WBC':'感染や炎症への防御に関わる白血球の数です。','Hb':'赤血球に含まれる、酸素を運ぶたんぱく質の量です。','PLT':'出血を止める働きに関わる血小板の数です。','CRP':'体内の炎症で増えるたんぱく質。炎症の程度をみる手がかりです。','PRO':'尿にたんぱく質が漏れていないかをみる検査です。','BLD':'尿に血液成分が混じっていないかをみる検査です。','GLU':'尿に糖が出ていないかをみる検査です。','BUN':'たんぱく質の代謝でできる老廃物。腎臓からの排泄や脱水の手がかりです。','Cys-C':'筋肉量の影響が比較的少ない、腎機能をみるためのたんぱく質です。','UACR':'尿に漏れる少量のアルブミンをクレアチニンで補正した値。早期の腎障害の手がかりです。','UPCR':'尿に漏れるたんぱく質をクレアチニンで補正した値です。','ALP':'胆道・骨などにある酵素。胆汁の流れや骨代謝の手がかりです。','LD':'全身の細胞にある酵素。細胞の傷害を広くみる手がかりです。','T-Bil':'赤血球の色素が分解されてできるビリルビン。肝臓での処理や胆汁の流れをみます。','ChE':'主に肝臓で作られる酵素。肝臓で合成する力や栄養状態の手がかりです。','RBC':'酸素を運ぶ赤血球の数です。','Ht':'血液中で赤血球が占める割合です。','MCV':'赤血球1個の平均的な大きさ。貧血の種類を考える手がかりです。','MCH':'赤血球1個に含まれるヘモグロビン量の目安です。','MCHC':'赤血球の中のヘモグロビン濃度の目安です。','Neut':'細菌などへの防御を担う好中球の割合です。','Lymph':'ウイルスへの反応や免疫に関わるリンパ球の割合です。','Na':'体の水分バランスや神経・筋肉の働きに関わる電解質です。','K':'心臓・筋肉・神経の働きに重要な電解質です。','Cl':'水分バランスや酸・塩基バランスに関わる電解質です。','Ca':'骨・神経・筋肉・血液凝固に関わるカルシウムの値です。','P':'骨・エネルギー代謝に関わるリンの値です。','Fe':'血液中を運ばれる鉄の量。鉄欠乏の評価に使います。','Ferritin':'体内に蓄えられている鉄の量の目安です。','Vit.B12':'赤血球づくりや神経の働きに必要なビタミンの量です。','Folate':'赤血球づくりや細胞分裂に必要な葉酸の量です。','AMY':'膵臓や唾液腺で作られる消化酵素です。','Lipase':'主に膵臓で作られる、脂肪を分解する消化酵素です。','CK':'主に骨格筋・心筋にある酵素。筋肉の傷害をみる手がかりです。','PT-INR':'血液が固まるまでの働きをみる検査。ワルファリン治療の管理にも使います。','APTT':'血液を固める経路の一部が適切に働くかをみる検査です。'
};
const categoryInfo={
